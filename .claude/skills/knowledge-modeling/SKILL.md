...
description: Interactive knowledge capture skill. Use when the user shares an article, file link, code snippet, or asks to discuss/explore a topic. Walks through the four-question thinking pipeline (Problem, Essence, Tradeoff, Transfer), supports both direct compression and discussion modes, and writes finalized knowledge to Notion Knowledge Units.
---
...
- User says "整理这个知识", "帮我压缩", "讨论一下 XXX"
